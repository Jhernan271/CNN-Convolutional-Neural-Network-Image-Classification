...
(UPDATE: Github is having issues rendering ipynb files currently. If you would like to view this file, open up the .ipynb file, copy the permalink, then paste into nbviewer.com)
